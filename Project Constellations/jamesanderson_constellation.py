...
constellation3d.scatter(x, y, z, c="#FF0000")
plt.title('Orion 3D Plot')
plt.show()
...
#alpha centauri and sirius celestial coordinates
x2 = [-1.643, -1.612]
y2 = [-1.374, 8.078]
z2 = [-3.838, -2.474]

fig_3d_2 = plt.figure()
constellation3d_2 = fig_3d_2.add_subplot(1, 1, 1, projection="3d")
constellation3d_2.scatter(x2, y2, z2, c="#00FF00")
plt.title('Alpha Centauri and Sirius Celestial Coordinates 3D')
plt.show()
